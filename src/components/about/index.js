     ...
     {/* <div className='left'>
       <div className='imgContainer'>
        ...
        <div className='text-center p-5'>
          <h2 className="text-4xl py-2 text-slate-600 font-medium font-burtons" >Jessica Jeyanthiran</h2>
          <h3 className='text-xl py-2'>Full Stack Web Developer.</h3>
          <p className="text-sm py-3 leading-8 text-slate-800">I am a full-stack web developer with a certificate earned from the University of Toronto. Equipped me with front end skills in HTML, CSS, Javascript, React.js, and responsive web development, as well as back end technologies such as Node. js, Express.js, MongoDB, MySQL.</p></div>
